...
function renderLista() {
    ...
    // El botón de "Ir a firmar" ahora está arriba con los controles y solo aparece si hay carga
...
function finalizar() {
    ...
    compDiv.innerHTML = `
        <div style="padding: 10px;">
            ...
            <button onclick="window.print()" style="background: #6c757d; margin-top:20px;">PDF</button>
            <button onclick="location.reload()" style="background: #28a745;">Nuevo</button>
        </div>
    `;
